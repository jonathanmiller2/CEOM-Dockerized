...
var Dajaxice = {
    ...
    get_task_progress: function(callback_function, argv, custom_settings){
        return Dajaxice.call('visualization.get_task_progress', 'GET', callback_function, argv, custom_settings);
    },

    get_multiple_task_progress: function(callback_function, argv, custom_settings){
        return Dajaxice.call('visualization.get_multiple_task_progress', 'GET', callback_function, argv, custom_settings);
    }
...
,
    ...
    getPhoto: function(callback_function, argv, custom_settings){
        return Dajaxice.call('eomf.towers.getPhoto', 'GET', callback_function, argv, custom_settings);
    },

    sayhello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('eomf.towers.sayhello', 'GET', callback_function, argv, custom_settings);
    }
    ...
    sayhello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('eomf.stats.sayhello', 'GET', callback_function, argv, custom_settings);
    }
    ...
    updateComment: function(callback_function, argv, custom_settings){
        return Dajaxice.call('eomf.feedback.updateComment', 'GET', callback_function, argv, custom_settings);
    },

    updateDB: function(callback_function, argv, custom_settings){
        return Dajaxice.call('eomf.feedback.updateDB', 'GET', callback_function, argv, custom_settings);
    }
...
,
    ...
    get_thumbnail: function(callback_function, argv, custom_settings){
        return Dajaxice.call('photos.get_thumbnail', 'GET', callback_function, argv, custom_settings);
    }
