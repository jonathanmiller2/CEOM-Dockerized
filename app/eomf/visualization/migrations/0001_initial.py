    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points', models.FileField(max_length=150, upload_to='visualization/timeseries/input', validators=[eomf.visualization.models.checkFormat], verbose_name='Upload csv file')),
