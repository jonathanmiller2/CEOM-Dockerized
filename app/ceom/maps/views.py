...
from django.shortcuts import render
import numpy, math
from ceom.maps.models import roi, map_gallery, poi

from ceom.maps.forms import map_gallery_form, CommentForm, PoiForm, roiForm
...
def prepare_kml(rois):
    ...
    response['Content-Disposition'] = 'attachment; filename="ceom_rois.kml"'
    return response
