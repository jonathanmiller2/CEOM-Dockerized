    ...
    def handle_noargs(self, **options):
        ...
        try:
            ...
            try:       
                ...
                msg =  "Input file processed: http://ceom.ou.edu"+job.points.url+"\n"
                msg += "Results can be downloaded at http://ceom.ou.edu"+job.result.url+"\n"
                msg += "Thank you for using our services\n\n"
                msg += "CEOM team"
                send_mail("Timeseries completed: "+name, msg, "noreply@ceom.ou.edu", mail_recipients, fail_silently=False)
