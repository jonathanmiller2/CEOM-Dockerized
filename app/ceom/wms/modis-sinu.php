...
<script type="text/javascript">
        ...
        function init(){
            var options = {
                controls: [],
                projection: new OpenLayers.Projection("EPSG:510501"),
            ...
            var jpl_wms2 = new OpenLayers.Layer.WMS("NASA Global Mosaic", 
                ["http://t1.hypercube.telascience.org/tiles?",
                 "http://t2.hypercube.telascience.org/tiles?",
                 "http://t3.hypercube.telascience.org/tiles?",
                 "http://t4.hypercube.telascience.org/tiles?"], 
            ...
            var ghyb2 = new OpenLayers.Layer.Google(
                "Google Hybrid",
                {type: G_HYBRID_MAP, 'sphericalMercator': true}
            );
            ...
            var yahoosat2 = new OpenLayers.Layer.Yahoo(
                "Yahoo Satellite",
                {'type': YAHOO_MAP_SAT, 'sphericalMercator': true}
            );
            var yahoohyb2 = new OpenLayers.Layer.Yahoo(
                "Yahoo Hybrid",
                {'type': YAHOO_MAP_HYB, 'sphericalMercator': true}
            );
            ...
            modis = new OpenLayers.Layer.WMS( "MODIS WMS", url, {layers: "TOP,BOT", isBaseLayer: true}, {'buffer':0});
            
            shade.setVisibility(false);
            map.addLayers([modis, layer, ghyb, yahoosat, yahoohyb, jpl_wms, shade]);
            ...
            layer = new OpenLayers.Layer.WMS( "OpenLayers WMS", 
                "http://labs.metacarta.com/wms/vmap0", {layers: 'basic'} );
            modis2 = new OpenLayers.Layer.WMS( "MODIS WMS", url, {layers: "TOP,BOT", isBaseLayer: true}, {'buffer':0});
            
            map2.addLayers([modis2, layer, ghyb2, yahoosat2, yahoohyb2, jpl_wms2,]);
        ...
        function updateMap(form) {
            ...
            modis_tmp = new OpenLayers.Layer.WMS( "MODIS WMS", url, {layers: "TOP,BOT", isBaseLayer: "true"});
            if (map_num == "1") { 
                modis = modis_tmp;
            } else if (map_num == "2") { 
                modis2 = modis_tmp;
