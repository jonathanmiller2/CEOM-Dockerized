# Generated by Django 2.2.13 on 2021-01-08 18:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headshot', models.ImageField(default='outreach/aboutus/dummy_headshot222.jpg', null=True, upload_to='outreach/aboutus/')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.CharField(blank=True, max_length=300, null=True)),
                ('logo', models.FileField(max_length=300, upload_to='outreach/sponsors/')),
            ],
            options={
                'unique_together': {('name',)},
            },
        ...
        migrations.CreateModel(
            name='Survey',
            fields=[
                ('demographicsurvey_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='outreach.DemographicSurvey')),
            ...
            bases=('outreach.demographicsurvey',),
        ),
        migrations.CreateModel(
            name='WorkshopClass',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('image', models.ImageField(upload_to='outreach/categories')),
            ],
            options={
                'unique_together': {('name',)},
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agenda', models.FileField(blank=True, max_length=300, null=True, upload_to='outreach/agendas/')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.WorkshopClass')),
            ],
            options={
                'unique_together': {('name',)},
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Year')),
            ],
        ),
        migrations.CreateModel(
            name='PersonInGroup',
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pvsgInGroup', to='outreach.AboutUsGroup')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pvsgInPerson', to='outreach.AboutUsPerson')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Year')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='outreach/overview/')),
                ('order', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.ItemDonor')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Year')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Year'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_text_field2', models.CharField(blank=True, max_length=100, null=True)),
                ('extra_text_field3', models.CharField(blank=True, max_length=100, null=True)),
                ('workshop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workshop', related_query_name='workshop', to='outreach.Workshop')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(blank=True, null=True, upload_to='outreach/photos')),
                ('priority', models.PositiveIntegerField(default=99999)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('workshop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workshop_images', to='outreach.Workshop')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categoryOfSponsorInYear', to='outreach.SponsorCategory')),
                ('sponsor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Sponsor')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Year')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sponsor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Sponsor')),
                ('workshop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Workshop')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.FileField(blank=True, max_length=300, null=True, upload_to='outreach/presentations/')),
                ('time_ini', models.DateTimeField()),
                ('time_end', models.DateTimeField(null=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Institution')),
                ('workshop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Workshop')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('validated', models.BooleanField()),
                ('preview', models.FileField(blank=True, max_length=300, null=True, upload_to='outreach/posters/')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.PosterCategory')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Year')),
            ],
            options={
                'unique_together': {('year', 'email')},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='outreach/announcements/')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outreach.Year')),
            ],
            options={
