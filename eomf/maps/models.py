...
class roi(models.Model):
	...
	category = models.ForeignKey(Category, null=True, blank=True, db_column='categoryid', related_name='rois')
...
class poi(models.Model):
	...
	lon = models.FloatField(blank=False, null=False)
	lat = models.FloatField(blank=False, null=False)
	user =  models.ForeignKey(User, null=False, blank=False, default=1829)
	score = models.IntegerField(blank=True, null=True)
	...
	created = models.DateTimeField('created', auto_now_add=True)
	modified = models.DateTimeField('modified', auto_now=True)
	category = models.ForeignKey(Category, null=True, blank=True, db_column='categoryid', related_name='pois')
	# pixelsize = models.IntegerField(blank=False, null=False)
...
class Comment(models.Model):
	Comment_id = models.ForeignKey(map_gallery, related_name='comment')
